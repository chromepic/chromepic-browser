...
//ChromePic
void SendScreenshotAck(int routing_id, int process_id, int snapshot_id, int event_id) override {
  std::stringstream log_stream;
  log_stream << "DEBUG OutputSurfaceWithoutParent::SendScreenshotAck, Event ID: " << event_id;
